"""
Experiment for the separated Hierarchical Transformer. This experiment mirrows the LTLSynHierTransformerExperiment but uses a separated hierarchichal transformer with two local encoder. The input is fed twice into the transformer.
"""
...
class LTLSynSepHierTransformerExperiment(LTLSynExperiment):
    ...
    def __create_hyperparams(self):
        ...
        # else:
        params["params_sep_local"] = [params_sep_local, params_sep_local]
        return params
    ...
    def prepare_eval_dataset(self, input_tensor):
        ltl_tensor, tpe_tensor = input_tensor
        return (ltl_tensor, ltl_tensor, tpe_tensor, tpe_tensor)
    ...
    def prepare_tf_dataset(self, tf_dataset):
        ...
        def shape_dataset(input_tensor, target_tensor):
            ltl_tensor, tpe_tensor = input_tensor
            return ((ltl_tensor, ltl_tensor, tpe_tensor, tpe_tensor, target_tensor), target_tensor)
